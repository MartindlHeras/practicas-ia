...
(defvar *jugador-burro* (make-jugador :nombre 'Jugador-humano
                                      :f-jugador #'f-jugador-negamax
                                      :f-eval  #'f-eval-burro1))

(defvar *jugador-burro2* (make-jugador :nombre 'Jugador-humano
                                       :f-jugador #'f-jugador-negamax
                                       :f-eval  #'f-eval-burro2))

(defvar *jugador-burro3* (make-jugador :nombre 'Jugador-humano
                                       :f-jugador #'f-jugador-negamax
                                       :f-eval  #'f-eval-burro3))
...
(print (partida *jugador-burro3* *jugador-burro*))
